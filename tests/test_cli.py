...
class TestGetProjectInfo:
    def test_get_project_info_success(self, cli_runner, httpx_mock):
        ...
        httpx_mock.add_response(
            url=httpx.URL(
                "https://gitlab.example.com/api/v4/projects/test%2Fproj",
                params={"statistics": "true"},
            ),
            json={
                "id": 100,
                "name": "proj",
                "path_with_namespace": "test/proj",
    ...
    def test_get_project_info_not_found(self, cli_runner, httpx_mock):
        ...
        httpx_mock.add_response(
            url=httpx.URL(
                "https://gitlab.example.com/api/v4/projects/nonexistent",
                params={"statistics": "true"},
            ),
            status_code=404,
...
class TestListFiles:
    def test_list_files_root_directory(self, cli_runner, httpx_mock):
        ...
        httpx_mock.add_response(
            url=httpx.URL(
                "https://gitlab.example.com/api/v4/projects/test%2Fproj/repository/tree",
                params={"per_page": "100"},
            ),
            json=[
...
class TestGetFile:
    def test_get_file_text_content(self, cli_runner, httpx_mock):
        ...
        httpx_mock.add_response(
            url=httpx.URL(
                "https://gitlab.example.com/api/v4/projects/test%2Fproj/repository/files/src%2Fmain.py",
                params={"ref": "main"},
            ),
    ...
    def test_get_file_binary_detection(self, cli_runner, httpx_mock):
        ...
        httpx_mock.add_response(
            url=httpx.URL(
                "https://gitlab.example.com/api/v4/projects/test%2Fproj/repository/files/data.root",
                params={"ref": "main"},
            ),
...
class TestGetReadme:
    def test_get_readme_success(self, cli_runner, httpx_mock):
        ...
        httpx_mock.add_response(
            url=httpx.URL(
                "https://gitlab.example.com/api/v4/projects/test%2Fproj/repository/files/README.md",
                params={"ref": "main"},
            ),
...
class TestSearchCode:
    ...
    def test_search_code_project_scoped(self, cli_runner, httpx_mock):
        ...
        httpx_mock.add_response(
            url=httpx.URL(
                "https://gitlab.example.com/api/v4/projects/test%2Fproj/search",
                params={
                    "search": "main",
                    "scope": "blobs",
                    "per_page": "20",
...
class TestListReleases:
    def test_list_releases_success(self, cli_runner, httpx_mock):
        ...
        httpx_mock.add_response(
            url=httpx.URL(
                "https://gitlab.example.com/api/v4/projects/test%2Fproj/releases",
                params={"per_page": "20"},
            ),
            json=[
                {
